...
//        dd($price-);
    ...
    ?>
        ...
        <table
            class="table <?php if($upsellingCount <= 0): ?>upsellingCartTable<?php endif; ?> table-bordered table-striped mw-cart-table mw-cart-table-medium mw-cart-big-table cart-table checkout-page-cart-table">
            <colgroup>
                <!-- <col width="80"> -->
                <!-- <col width="200"> -->
                <!-- <col width="100"> -->
        ...
        <div style="margin-top:20px; line-height: 20px;" class="checkout-checkbox">
            ...
            <?php if ($terms): ?>
                ...
                <div style="display:flex;justify-content:flex-end;" id="i_agree_with_terms_row">
                    ...
                    <div class="ch-checkbox" style="display:flex;align-items:center">
                        <span class="edit" field="content1" rel="page1" style="margin-right: 5px;"><?php _e('Ich akzeptiere die'); ?></span>
            ...
            <?php if ($terms2): ?>
                ...
                <div style="display:flex;margin-top:10px;justify-content:flex-end;" id="i_agree_with_terms_row">
                    <div class="ch-checkbox" style="display:flex;align-items:center">
                        <span class="edit" field="content2" rel="page2" style="margin-right: 5px;"><?php _e('Ich habe das'); ?></span>
        ...
        if (is_array($shipping_options)) :?>
            ...
            <div class="row checkout-total-table-row">
               ...
               ?>
                ...
                <label for="myCheck">I agree to Terms & Condition:</label> 
...
<script>
    $('.country-rate').change(function (){
        $.post("<?= url('/') ?>/api/v1/cart_totals", { data:$(this).val() }, (res) => {
    ...
    mw.on('mw.cart.qty', function (event, data) {
        $.post("<?= url('/') ?>/api/v1/cart_totals", { data:$("#country_set").val() }, (res) => {
            $('.cell-cart-price-total-subtotal').html(res.cart_totals.subtotal.amount)
            $('.cell-cart-price-total-tax').html(res.cart_totals.tax.amount)
            $('.cell-cart-price-total-total').html(res.cart_totals.total.amount)
            $('.cell-cart-price-total-netto').html(res.cart_totals.netto.amount)
