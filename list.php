...
<ul class="modules-list list-<?php print $mod_obj_str ?>" ocr="off">
    ...
    <!-- <li class="module-item-module" style="float:none !important;">
        <a href="https://drm.software/admin/contact_forms" style="display:inline-block;" target="_blank">
            <span class="mw_module_hold">
                <span class="mw_module_image">
                    <img src="<?php print modules_url(); ?>contact_form.png" alt="">
                </span>
        ...
        foreach ($module_layouts_skins as $dynamic_layout): ?>
            <?php if (isset($dynamic_layout['layout_file'])): ?>
                <li data-module-name="layouts" ondrop="true" template="<?php print $dynamic_layout['layout_file'] ?>"
                    data-filter="<?php print $dynamic_layout['name'] ?>" class="<?php if($dynamic_layout['name'] == "Contact Form"){ ?> hide-li <?php } ?> module-item module-item-layout"
                    unselectable="on">
                    <span class="mw_module_hold">
                        <?php
            ...
            <?php foreach ($modules as $module_item): ?>
                ...
                <?php if (isset($module_item['module'])): ?>
                    ...
                    <li <?php if (isset($hide_from_display_list) and in_array($module_item['module'], $hide_from_display_list)) { ?> style="display: none"   <?php } ?>   <?php if (!isset($params['clean'])) { ?> id="<?php print $module_id; ?>" <?php } ?>
                        ...
                        <?php } ?>
                            class="<?php if($module_item['name'] == "Dropfunnels" || $module_item['name'] == "Preisvergleich-Export" || $module_item['name'] == "Contact-form"){ ?> hide-li <?php } ?> module-item module-item-module module-cat-toggle-<?php print $mod_cat ?> <?php if ($mod_obj_str == 'elements'): ?>default-layouts<?php endif; ?><?php if (isset($module_item['as_element']) and intval($module_item['as_element'] == 1) or (isset($is_elements) and $is_elements == true)) : ?> module-as-element<?php endif; ?>">
                    <span unselectable="on" class="mw_module_hold"
                          title="<?php _e(addslashes($module_item["name"]).' '.addslashes($module_item["description"])); ?>">
